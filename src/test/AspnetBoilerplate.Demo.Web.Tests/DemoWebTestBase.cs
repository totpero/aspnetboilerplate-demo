...
{
    public abstract class DemoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DemoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DemoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DemoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DemoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DemoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DemoDbContext, Task<T>> func)
        {
            T result;
